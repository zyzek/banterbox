...
},{"./auth":2,"./components/App.vue":4,"./components/Home.vue":5,"./components/Login.vue":6,"./components/NotFound.vue":7,"./components/Room.vue":9,"./components/RoomListing.vue":10,"./store":12,"vue":123,"vue-resource":121,"vue-router":122}],2:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-24634b91", module.exports)
  } else {
    hotAPI.update("_v-24634b91", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}

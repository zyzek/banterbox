...
exports.default = {
    ...
    methods: {
        createUser: function createUser() {
            ...
            this.$http.get('/api/demo/user').then(function (response) {
                ...
                if (fail.status === 429) {
                    _this.demo.error_message = fail.data.detail;
                } else {
                    _this.demo.error_message = 'An unknown error has occured. Our highly paid team of specialists are working on it! ';
                }
